...
One function call of \texttt{calc(a, b)} increments \texttt{counter} by 1, and calls the function \texttt{calc(a, b/3)}. This can be mathematically written as the equation below.

\begin{equation}
    \texttt{calc(a,b)} = 1 + \texttt{calc(a,b/3)}
\end{equation}
...
\begin{align}
    \texttt{calc(a,b)} &= 1 + \texttt{calc(a,b/3)} \\
    \texttt{calc(a,b/3)} &= 1 + \texttt{calc(a,b/3}^2\texttt{)} \\
    ...     \texttt{calc(a,3)} &= 1
\end{align}
