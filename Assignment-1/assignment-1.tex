...
\section{\textbf{Mathematical Formula}}

One function call of \texttt{calc(a, b)} increments \texttt{counter} by 1, and calls the function \texttt{calc(a, b/3)}. This can be mathematically written using a function f, that returns the \texttt{counter} variable value as shown below.
...
\begin{align}
   & \texttt{b/3}^\texttt{n} = 1 \\
   &\log_3{\texttt{b}} = \log_3{\texttt{3}^\texttt{n}} & \implies \texttt{n} = \log_3{\texttt{b}}
\end{align}
